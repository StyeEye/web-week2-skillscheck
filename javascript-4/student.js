...
// CODE HERE
const faveColors = ["red", "violet", "blue"];
...
// CODE HERE
const me = {
    firstName: "The secret joke definitely won't get old",
    superHeroName: "Bob the builder",
    homeTown: "Space Utah (Sector 4)",
    superPowers: ["Super speeding", "Somewhat fast reaction time", "Teleportation (to nearest Arbys)"],
    superPowerXP: () => Math.floor(Math.random() * 101),
    profileImage: () => `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10)}.jpg`
}
